            ...
            <div className="navigation_bar">
                ...
                <div className="flex-container">
                    ...
                    <div className="flex-child magenta">
                        ...
                        <br/><br/>
                        Cena: {this.props.DataStorage.cena.at(0)}
                    </div>
                    ...
                    <div className="flex-child green">
                        ...
                        <br/><br/>
                        Cena: {this.props.DataStorage.cena.at(1)}
                    </div>
                    ...
                    <div className="flex-child blue">
                        ...
                        <br/><br/>
                        Cena:  {this.props.DataStorage.cena.at(3)}
                    </div>
                    ...
                    <div className="flex-child yellow">
                        ...
                        <br/><br/>
                        Cena:  {this.props.DataStorage.cena.at(4)}
                    </div>
                    <div className="flex-child white">
                        ...
                        <br/><br/>
                        Cena:  {this.props.DataStorage.cena.at(5)}
